package com.geofahm.shahrdari.model.controller.sport;
...
@RequestMapping("/sport191")
public class Sport191Controller {
    ...
    @Autowired
    public Sport191Controller(Tamin161Service service, JwtUtils jwtUtils, UsersRepository usersRepository) {
